...
def main():
    ...
    desired_duration = 5  # Desired duration in seconds
    #simulation_steps = 1000
    simulation_steps = int(desired_duration / time_step)
    ...
    for i in range(simulation_steps):
        ...
        p.stepSimulation()
        time.sleep(time_step*desired_duration)
        p.setJointMotorControlArray(robot,
                                range(7),
                                p.POSITION_CONTROL,
                                targetPositions=final_joint_positions
